package id.my.rizkiyuwanda.views.gridwithfilters;
...
import id.my.rizkiyuwanda.data.entity.SamplePerson;
import id.my.rizkiyuwanda.data.service.SamplePersonService;
